<?php
// Bootstrap Laravel to use route() function
require __DIR__.'/../vendor/autoload.php';
$app = require_once __DIR__.'/../bootstrap/app.php';
$app->make(\Illuminate\Contracts\Http\Kernel::class)->bootstrap();

// Now we can use Laravel functions like route()
$freightRoute = route('freight.calculator');
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    <div class="container mt-3">
        <div class="row">
            <div class="col-12">
                <a href="<?php echo $freightRoute; ?>" class="btn btn-secondary mb-3">
